...
1. **Тестирование преобразований**:
    ...
    - Тестирование рандомных значений с проверкой на [сайте](https://colorscheme.ru/color-converter.html)
...
### RGB → HSV
**Проблема:** RGB (красный, зеленый, синий) — это как говорить о цвете на языке компьютера. Людям так неудобно.

**Решение:** HSV разбивает цвет на:

- H — сам цвет (красный, синий, зеленый)

- S — насыщенность (бледный или яркий)

- V — яркость (темный или светлый)

**Погрешности:** Почти нет. Преобразуется точно туда-обратно.

**Когда использовать:** Когда нужно сделать цвет светлее/темнее или изменить оттенок в программе.

### RGB ↔ LAB
**Проблема:** Наш глаз видит цвета нелинейно. Например, разница между темно-синим и черным кажется маленькой, а между двумя светло-зелеными — большой.

**Решение:** LAB учитывает особенности нашего зрения. Расстояние между цветами в LAB соответствует тому, насколько мы реально видим разницу.

**Погрешности:**

- Могут быть небольшие потери при преобразовании туда-обратно

- Вычисления сложные, требует много ресурсов

**Когда использовать:** Когда нужно точно измерить "похожесть" цветов (поиск похожих товаров, анализ изображений).

# Отчет по лабораторной работе "Исследование цветовых моделей"

## Цель работы

Разработка интерактивного веб-приложения для изучения цветовых моделей RGB, HSV, LAB и преобразований между ними. Создание удобного интерфейса, позволяющего пользователю интерактивно исследовать цветовые пространства и их взаимосвязи.
...
1. **Достигнуты цели работы** - создано полнофункциональное веб-приложение для исследования цветовых моделей с корректными преобразованиями между RGB, HSV и LAB.

2. **Интерфейс соответствует требованиям** - предоставляет три способа задания цвета для каждой модели, интерактивное изменение и автоматическую синхронизацию.
...
4. **Приложение готово к использованию** - работает в основных браузерах, имеет удобный интерфейс и может использоваться для образовательных целей изучения цветовых моделей.

5. **Основная сложность** заключалась в реализации точных преобразований между перцептивно-неравномерными моделями (RGB) и перцептивно-равномерными (LAB), требующих промежуточных преобразований через XYZ пространство.